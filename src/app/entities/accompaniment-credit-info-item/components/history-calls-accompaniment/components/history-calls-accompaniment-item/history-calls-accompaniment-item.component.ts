...
@Component({
  selector: 'app-history-calls-accompaniment-item',
  templateUrl: './history-calls-accompaniment-item.component.html',
  styleUrls: [
    '../../../../../credit-info-item/components/history-call/history-call.component.scss',
    './history-calls-accompaniment-item.component.scss',
  ],
})
export class HistoryCallsAccompanimentItemComponent
